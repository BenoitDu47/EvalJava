...
INSERT INTO T_Trainings (TrainingName, Description, UnitaryPrice, Quantity, Duration, Distential, IdCategory ) VALUES ( 'Java debutant', 'Formation axee sur les bases de la programmation en Java, y compris la syntaxe, la POO et la gestion de fichiers.', 2500, 9, 15, true, 2 );
INSERT INTO T_Trainings (TrainingName, Description, UnitaryPrice, Quantity, Duration, Distential, IdCategory ) VALUES ( 'App de bureau Java', 'Formation axee sur la creation d applications de bureau en utilisant Java et le framework Swing pour creer des interfaces utilisateur graphiques.', 2800, 10, 15, true, 2 );
INSERT INTO T_Trainings (TrainingName, Description, UnitaryPrice, Quantity, Duration, Distential, IdCategory ) VALUES ( 'App mobiles Android Java', 'Formation axee sur le developpement d applications mobiles Android en utilisant Java et l Android SDK, avec des competences en creation d interfaces utilisateur et en integration de fonctionnalites telles que la geolocalisation.', 4000, 8, 21, false, 2 );
INSERT INTO T_Trainings (TrainingName, Description, UnitaryPrice, Quantity, Duration, Distential, IdCategory ) VALUES ( 'App web Java', 'Formation axee sur le developpement d applications web en utilisant Java, y compris la creation de servlets, la gestion des sessions utilisateur et l integration de bases de donnees en utilisant JDBC.', 3200, 15, 15, false, 2 );
INSERT INTO T_Trainings (TrainingName, Description, UnitaryPrice, Quantity, Duration, Distential, IdCategory ) VALUES ( 'HTML, CSS et JavaScript', 'Formation axee sur les competences de base pour la creation de pages web, y compris la structure HTML, la mise en forme CSS et l interaction utilisateur JavaScript.', 7800, 30, 30, true, 1 );
...
INSERT INTO T_Trainings (TrainingName, Description, UnitaryPrice, Quantity, Duration, Distential, IdCategory ) VALUES ( 'Linux', 'Formation axee sur les competences de base pour l administration de systemes Linux, y compris la gestion des utilisateurs, la configuration reseau et la securite.', 5000, 9, 21, false, 3 );
INSERT INTO T_Trainings (TrainingName, Description, UnitaryPrice, Quantity, Duration, Distential, IdCategory ) VALUES ( 'Bases de donnees', 'Formation axee sur l administration de systemes Windows Server, y compris la gestion des utilisateurs, la configuration du reseau et la securite.', 4700, 8, 21, true, 3 );
INSERT INTO T_Trainings (TrainingName, Description, UnitaryPrice, Quantity, Duration, Distential, IdCategory ) VALUES ( 'Windows Server', 'Formation axee sur l administration de bases de donnees, y compris la creation de tables, la gestion des utilisateurs et la maintenance de la base de donnees.', 4000, 7, 15, true, 3 );
INSERT INTO T_Trainings (TrainingName, Description, UnitaryPrice, Quantity, Duration, Distential, IdCategory ) VALUES ( 'S. des reseaux informatiques', 'Formation axee sur la securite des reseaux informatiques, y compris la configuration des pare-feux, la detection des intrusions et la mise en place de politiques de securite.', 12000, 20, 60, true, 4 );
INSERT INTO T_Trainings (TrainingName, Description, UnitaryPrice, Quantity, Duration, Distential, IdCategory ) VALUES ( 'S. des applications web', 'Formation axee sur la securite des applications web, y compris la detection des vulnerabilites, la protection contre les attaques par injection et la mise en place de politiques de securite pour les applications web.', 11000, 6, 31, false, 4 );
